...
import numpy as np
import mmtrack.models.pose as pose
from mmtrack.models.pose.SPPE.src.utils.img import flip, shuffleLR
from mmtrack.models.pose.SPPE.src.utils.eval import getPrediction
from mmtrack.models.pose.SPPE.src.models.FastPose import FastPose
...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, weights_file=osp.join(osp.dirname(pose.__file__), 'Models/sppe/fast_res50_256x192.pth')):
        super().__init__()
