...
class DeepOCSORT(BaseMultiObjectTracker):
    """DeepOCSORT: Deep Appearance-enhanced Observation-Centric SORT

    This tracker extends OC-SORT with a deep appearance model for ReID-based
    matching, based on BoxMot's DeepOCSORT design.

    Args:
        detector (dict): Configuration of detector. Defaults to None.
        tracker (dict): Configuration of DeepOCSORT tracker. Defaults to None.
        motion (dict): Configuration of motion model. Defaults to None.
    ...
    def simple_test(self, img, img_metas, rescale=False, **kwargs):
        ...
        # Step 2: Convert detector output
        ...
        # Step 3: DeepOCSORT tracking update with appearance features
