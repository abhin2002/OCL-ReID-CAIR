...
class ByteTrack(BaseMultiObjectTracker):
    ...
    def __init__(self,
        ...
        self.save_dir = "/home/jing/Data/Projects/Mono-Following/codes/baselines/evaluation-on-JRDB/mmtracking-based/results/rpf/visualized"
    ...
    def simple_test(self, img, img_metas, rescale=False, **kwargs):
        ...
        # dir_file = img_metas[0]['filename'].split("/")[-2:]
        # out_dir = osp.join(self.save_dir, dir_file[0])
        # if not osp.exists(out_dir):
        #     os.mkdir(out_dir)
        # out_file = osp.join(out_dir, dir_file[1])
        # self.show_result(img_metas[0]['filename'], 
        #                  raw_result,
        #                  out_file=out_file)
        # print(out_file)
