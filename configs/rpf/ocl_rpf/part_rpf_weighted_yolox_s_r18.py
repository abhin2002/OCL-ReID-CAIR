_base_ = [
    '../../_base_/models/yolox_s_8x8.py', # '../../_base_/models/yolox_l_8x8.py',
...
model = dict(
    ...
    detector=dict(
        ...
        bbox_head=dict(num_classes=80),  # original: 1, change to: 80
        test_cfg=dict(score_thr=0.6, nms=dict(type='nms', iou_threshold=0.35)),
        init_cfg=dict(
            type='Pretrained',
    ...
    reid=dict(
        ...
        init_cfg=dict(
            ...
            'OnlineReID/checkpoints/reid/resnet18.pth'  # noqa: E501
        )),
    tracker=dict(
        type='ByteTracker',
        ...
        match_iou_thrs=dict(high=0.1, low=0.5, tentative=0.3),  # original-high-0.1; original-low-0.5; original-tentative-0.3
        num_frames_retain=10),  # original-30, 10 is ok;
    identifier=None,
    hyper_config=None
    )
