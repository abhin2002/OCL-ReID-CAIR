...
rpf_config = "configs/rpf/ocl_rpf/global_rpf_yolox_l_r18.py"
identifier_config = "configs/rpf/ocl_configs/global_lt_reservoir.py"
...
description = "oclreid_finetuned_global_resnet18"
